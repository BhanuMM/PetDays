...
import '../styles/forumpendingposts.css';
import Profilepic from '../images/profile.jpg';
import Footer from '../components/footer';
import Navbar from '../components/navbar';


function forumpendingposts() {
  return (
    <div className='forumpendingposts'>
      <Navbar/><br/><br/><br/><br/>
      <div className='container'>
      <div className='container-fluid forumpendingposts'>
        <div class="row g-0 ">
          <div class="col-sm-6 col-md-8">
            <div class='forumpendingposts-header'>
              <div class='forumpendingposts-btn'>
              ...
              {/* <div class='forumpendingposts-search'>  
            ...
            <div class="card-body">
                <div class="content">
                  <div>
                    <p class="fw-semibold fs-7"><i class='bx bxs-hourglass-top'></i> My dog's Injury</p>
                    <p class="font-italic text-success fs-7">Posted 2 days ago</p>
                  </div>  
                  <div>
...
export default forumpendingposts
