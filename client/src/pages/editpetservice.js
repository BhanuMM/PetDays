    ...
    <div class="container-fluid">
      ...
      <div className='row'>
          ...
          <div className="row flex-nowrap pt-5 pl-5 ml-5">
            ...
            <h3 className='mb-5'> + Edit Advertiesment <hr/></h3>


                <form>
                <div class="mb-3">
                    <label for="exampleInputEmail1" class="form-label">Service Provider</label>
                    <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="Dog Friends" />
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="exampleInputPassword1" value="Rs.2000"  />
                </div>
                <div class="mb-3">
                    <label for="exampleInputPassword1" class="form-label">Description</label>
                    <input type="text" class="form-control" id="exampleInputPassword1" value=" Keep your dog happy and in greate space with our help.
              Let we take care of your pet while you are away."/>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="exampleInputPassword1" value="+9471 43 58 743"/>
                </div>
                <div class="mb-3">
                    <label for="exampleInputPassword1" class="form-label">Facebook Link</label>
                    <input type="text" class="form-control" id="exampleInputPassword1" value="www.facebook.com/dogfraiends"/>
                </div>
                <div class="mb-3">
                    <label for="exampleInputPassword1" class="form-label">Email Address</label>
                    <input type="text" class="form-control" id="exampleInputPassword1" value="www.dogfriends@gmail.com"/>
                </div>
