    ...
    >
					<div class="container-fluid" style={{ width:250 }} >
                        ...
                        <div style={{ paddingLeft:20}}>
                            ...
                            <img class="dashboard-image" src={Profilepic} alt="" style={{ height:90 , width: 90, marginLeft: 40, borderRadius:'50%'}} />
                            </a><br/><br/>
                            
                        </div>
                        <div>
                                <center><strong><p style={{ fontSize:20}}>
                                Hello !<br/></p>
                        ...
                        <center><hr style={{ width:200 , paddingLeft:40, color:'#205375'}} /></center>
